...
ALLOWED_HOSTS = [
    '8000-attilafawal-portalsneak-ym8j3bemz16.ws-eu105.gitpod.io',
    'localhost',
...
INSTALLED_APPS = [
    ...
    'allauth.socialaccount', 'home', 'products', 'bag',
    'checkout', 'profiles', 'comments', 'crispy_forms', 'storages',
]
...
if 'USE_AWS' in os.environ:
    ...
    AWS_STORAGE_BUCKET_NAME = 'portal-sneakers'
